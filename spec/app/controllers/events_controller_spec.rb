  ...
  describe '#index' do
    ...
    context 'given a date range as params' do
      ...
      it 'returns all the events in the given range' do
        ...
        expect(response.body).to match(/2014-02-20T13:00/)
        expect(response.body).to_not match(/2014-02-15T13:00/)
        expect(response.body).to_not match(/2014-02-25T13:00/)

        expect(response.body).to match(/2014-02-18T13:00/)
        expect(response.body).to match(/2014-02-22T13:00/)
        expect(response.body).to_not match(/2014-02-18T12:59/)
        expect(response.body).to_not match(/2014-02-22T13:01/)
      end
    end
  end
